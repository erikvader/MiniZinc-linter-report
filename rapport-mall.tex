...
formulation below is searched for, i.e.\@ a \mi{forall} that constrains every element to a
...
In the example below is the variable \mi{a} functionally defined in terms of \mi{b} and \mi{c}.
If \mi{b} and \mi{c} are fixed to some values can the value of \mi{a} be obtained. In this
case must \mi{b} and \mi{c} be included in the search annotation, it is optional for
\mi{a} to be included.
Simple assignment is also a way to functionally defined variables, i.e.\@ \mi{var int: a=5*b+c}.
\begin{mznnobreak}
